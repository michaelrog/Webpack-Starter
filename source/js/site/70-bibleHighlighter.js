...
window.BIBLESEARCH.jQuire =
    ...
    function(b) {
        ...
        var a = {
            ...
            h = [window.jQuery, window.BIBLESEARCH.jQuery],
            p = false;
        if (typeof b === "function") a.onLoad = b;
        else for (var k in b) if (b.hasOwnProperty(k)) a[k] = b[k];
        ...
        p ||
        u(a.loadFrom, function() {
			window.BIBLESEARCH.jQuery = window.BIBLESEARCH.$ = window.jQuery.noConflict(true);
            l(a.onLoad, window.BIBLESEARCH.$);
        });
    };
var BIBLESEARCH = window.BIBLESEARCH || {};
BIBLESEARCH.defineFancybox =
    BIBLESEARCH.defineFancybox ||
    function(O) {
        O.fn.fancybox ||
        (function(A, J, f, B) {
            ...
            f.extend(b, {
                        ...
                        if (false !== b.close(true)) {
                            ...
                            f.each(a, function(e, c) {
                                ...
                                if (!k && g.isDom) {
                                    ...
                                    if (!k)
                                        k = (k = c.prop("class").match(/fancybox\.(\w+)/))
                                            ? k[1]
                                            : null;
                                }
                                if (u(h)) {
                ...
                play: function(a) {
                    var d = function() {
                        ...
                        e = function() {
                            d();
                            if (b.current && b.player.isActive)
                ...
                jumpto: function(a, d, e) {
                    ...
                    if (c) {
                        ...
                        b.router = e || "jumpto";
                        if (c.loop) {
                            if (a < 0) a = c.group.length + (a % c.group.length);
                            a %= c.group.length;
                        }
                        if (c.group[a] !== B) {
                            b.cancel();
                    ...
                    (G = setTimeout(
                        function() {
                            ...
                            if (!(!c || b.isClosing)) {
                                ...
                                if (e || d === "load" || (d === "resize" && c.autoResize))
                                    b._setDimension();
                ...
                unbindEvents: function() {
                    b.wrap && D(b.wrap) && b.wrap.unbind(".fb");
                    o.unbind(".fb");
                    n.unbind(".fb");
                },
                bindEvents: function() {
                    ...
                    if (a) {
                        ...
                        o.bind("keydown.fb", function(e) {
                            ...
                            if (
                                ...
                                !e.shiftKey &&
                                !e.metaKey &&
                                !(g && (g.type || f(g).is("[contenteditable]")))
                            )
                        ...
                        f.fn.mousewheel &&
                        a.mouseWheel &&
                        b.wrap.bind("mousewheel.fb", function(e, c, g, h) {
                            for (var i = f(e.target || null), j = false; i.length; ) {
                                ...
                                j =
                                    i[0] &&
                                    !(
                                        i[0].style.overflow && i[0].style.overflow === "hidden"
                                    ) &&
                                    ((i[0].clientWidth &&
                                        i[0].scrollWidth > i[0].clientWidth) ||
                                        (i[0].clientHeight &&
                            ...
                            if (c !== 0 && !j)
                                if (b.group.length > 1 && !a.canShrink) {
                                    if (h > 0 || g > 0) b.prev(h > 0 ? "down" : "left");
                ...
                trigger: function(a, d) {
                    ...
                    if (c) {
                        ...
                        c.helpers &&
                        f.each(c.helpers, function(g, h) {
                            h &&
                            b.helpers[g] &&
                            f.isFunction(b.helpers[g][a]) &&
                            b.helpers[g][a](
                                f.extend(true, {}, b.helpers[g].defaults, h),
                                c
                            );
                        });
                        o.trigger(a);
                ...
                _start: function(a) {
                    ...
                    if (d.width === "auto") d.autoWidth = true;
                ...
                _loadIframe: function() {
                    var a = b.coming,
                        d = f(a.tpl.iframe.replace(/\{rnd\}/g, new Date().getTime()))
                            .attr("scrolling", r ? "auto" : a.iframe.scrolling)
                            .attr("src", a.href);
                ...
                _preloadImages: function() {
                    ...
                    for (h = 1; h <= c; h += 1) {
                        g = a[(d.index + h) % e];
                        if (g.type === "image" && g.href) new Image().src = g.href;
                    }
                },
                _afterLoad: function() {
                    var a = b.coming,
                ...
                _setDimension: function() {
                    ...
                    M = l(g.outerHeight(true) - g.height());
                    w = v + t;
                    H = E + M;
                    ...
                    if (i.type === "iframe") {
                        I = i.content;
                        if (i.autoHeight && I.data("ready") === 1)
                            try {
                ...
                _getPosition: function(a) {
                    ...
                    if (d.autoCenter && d.fixed && !a && h <= e.h && g <= e.w)
                        c.position = "fixed";
                    else if (!d.locked) {
                        c.top += e.y;
                        c.left += e.x;
                    ...
                    c.left = s(Math.max(c.left, c.left + (e.w - g) * d.leftRatio));
                    return c;
                },
                _afterZoomIn: function() {
                    ...
                    if (a) {
                        ...
                        b.update();
                        if (a.closeClick || (a.nextClick && b.group.length > 1))
                        ...
                        if (a.arrows && b.group.length > 1) {
                            if (a.loop || a.index > 0)
                                f(a.tpl.prev)
                                    .appendTo(b.outer)
                                    .bind("click.fb", b.prev);
                            if (a.loop || a.index < b.group.length - 1)
                                f(a.tpl.next)
                                    .appendTo(b.outer)
            ...
            b.helpers.overlay = {
                ...
                close: function() {
                    ...
                    f(".fancybox-overlay")
                        .remove()
                        .hide();
                    f.extend(this, { overlay: null, fixed: false });
                },
                update: function() {
                    var a = "100%",
                        d;
                    ...
                    } else if (o.width() > n.width()) a = o.width();
            ...
            f.fn.fancybox = function(a) {
                ...
                d = a.index || 0;
                !c || a.live === false
                    ? e.unbind("click.fb-start").bind("click.fb-start", g)
                    : o
...
window.BIBLESEARCH.highlighterBooks = {
    ...
    "2Thess":
        "2thess,iithess,2th,iith,2 thessalonians,ii thessalonians,2 th,ii th",
...
(function(p, n, B) {
    ...
    function D(a) {
        function d() {
            j("iframe")
                .filter(function() {
                    return (
                        this.src.match(/youtube\.com/) && !this.src.match(/wmode=opaque/)
                    );
                })
                .each(function() {
                    var g = this.src;
        ...
        var b = { __linker__: "1", "disp[]": "1" },
            e = [
                p.location.protocol,
                "//",
                a.host,
                "/linker/fancybox2/jquery.fancybox.css"
            ].join(""),
            c = {
                type: "iframe",
                aspectRatio: false,
        ...
        j.each(["languages", "versions"], function(g, f) {
            if ("string" === j.type(a[f]) && a[f].match(/^[a-z0-9\-,]+$/i))
                b["disp[" + f + "]"] = a[f];
        });
        b["disp[versionChooser]"] = a.versionChooser ? 1 : 0;
        a.fixYoutube && d();
		window.BIBLESEARCH.defineFancybox(j);
        j("<link>")
            .attr({ rel: "stylesheet", media: "screen", href: e })
            .appendTo("head");
        j("body").delegate("a." + a.linkClass, "click", function(g) {
            ...
            j.fancybox(j.extend({}, c, { href: g.data("fancybox-href") }));
        });
    }
    function q() {
    ...
    function w(a, d) {
        ...
        if (a && a.nodeType) {
            ...
            if (d > h.maxdepth + 1) return b;
                ...
                if (h.existingLinkMatch.exec(a.href) && !h.linkClassMatch.exec(c))
                    a.className = A(c + " " + h.linkClass);
                b = 0;
            }
            if (null === b) {
                b = a.childNodes;
    ...
    function x(a, d, b, e) {
        ...
        if (!c && e && (c = h.matchNext.exec(a))) {
            ...
            b.push({ book: e.book, chapter: f, verse: g, text: k, version: c[8] });
        }
    ...
    function y(a, d) {
        ...
        b.href = [
            ...
            h.host,
            "/",
            h.version2url[(a.version || h.version).toLowerCase()],
            "/",
            h.book2url[a.book.toLowerCase()],
            "/",
            a.chapter,
            "/",
            a.verse
    ...
    window.BIBLESEARCH.jQuire({
        ...
        onLoad: function(a) {
            ...
            if (b.hasOwnProperty("ssl"))
                if (u(b.ssl) && b.ssl.match(/^(?:on|off|match)$/i))
                    b.ssl = b.ssl.toLowerCase();
                else delete b.ssl;
            o.linkClassMatch = RegExp("\\b" + r(o.linkClass) + "\\b", "i");
            o.existingLinkMatch = RegExp(
                "^https?://" + o.host + "/(?:" + i.allOsisIDs.join("|") + ")/",
                "i"
            );
            d = j.extend(E || {}, b, o, i);
            d.ignoreClassMatch = RegExp("\\b" + r(d.ignore) + "\\b", "i");
            d.protocol =
                d.ssl === "match" && n.location.protocol.match(/^http/)
                    ? n.location.protocol
                    : ["http", d.ssl === "on" ? "s" : "", ":"].join("");
            h = d;
            a(C);
        }
    });
